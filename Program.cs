        ...
        static void WriteSeason( string season)
        {
            switch (season)
            {
                case "summer":
                    ...
                    break;
                case "winter": Console.WriteLine("Праздники в данный промежуток\n" + "07.01 Рождество Христово\n" + "23.02 День защитника Отечества\n" + "01.01 Новый год\n");
                    break ;
                case "spring": Console.WriteLine("Праздники в данный промежуток\n" + "08.03 8 марта\n" + "12.05 мой день рождения\n" + "09.04 Пасха\n");
                    break;
                case "autumn": Console.WriteLine("Праздники в данный промежуток\n" + "01.09 День знаний\n" + "06.10 День учителя\n" + "17.11 Международный день студента\n");
                    break;
            }
        }
